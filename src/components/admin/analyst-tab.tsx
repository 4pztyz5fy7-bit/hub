...
import {
  Users, Package, DollarSign, Wallet, TrendingUp, Activity,
  Sparkles, RefreshCw,
} from "lucide-react";
    ...
    <div className="space-y-4">
      <div className="rounded-2xl border border-border bg-gradient-to-br from-primary/10 via-card to-card p-4">
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => void load()} className="ml-auto text-muted-foreground hover:text-foreground" aria-label="Обновить">
